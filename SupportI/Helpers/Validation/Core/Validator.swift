...
public class Validator {
    ...
    */
    ...
    /**
    This method is used to style fields that have undergone validation checks. Success callback should be used to show common success
     //styling and error callback should be used to show common error styling.
    ...
    */
    ...
    /**
     ...
     - returns: No return value.
     */
    public func validate(callback:(_ errors: [UITextField: ValidationError]) -> Void) {
