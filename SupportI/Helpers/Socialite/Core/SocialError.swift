...
extension SocialError {
    func alertError(){
        ...
        let alert = UIAlertController(title: "your_are_cancel_the_operation.lan".localized, message: "you_must_accept_the_request_to_login.lan".localized, preferredStyle: .alert)
