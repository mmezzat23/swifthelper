...
@objc extension UIView {
    public func showLoader() {
        ...
        if self is UITableView {
            ListLoader.addLoaderTo(self as? UITableView ?? UITableView())
        } else if self is UICollectionView {
            ListLoader.addLoaderTo(self as? UICollectionView ?? UICollectionView())
        } else {
    ...
    public func hideLoader() {
        ...
        if self is UITableView {
            ListLoader.removeLoaderFrom(self as? UITableView ?? UITableView())
        } else if self is UICollectionView {
            ListLoader.removeLoaderFrom(self as? UICollectionView ?? UICollectionView())
        } else {
...
@objc extension UIView {
    fileprivate func ld_getCutoutView() -> UIView? {
        return objc_getAssociatedObject(self, &cutoutHandle) as? UIView? ?? UIView()
    }
    ...
    fileprivate func ld_getGradient() -> CAGradientLayer? {
        return objc_getAssociatedObject(self, &gradientHandle) as? CAGradientLayer? ?? CAGradientLayer()
    }
